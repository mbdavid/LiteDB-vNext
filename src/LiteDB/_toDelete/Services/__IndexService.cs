...
/// </summary>
[AutoInterface]
internal class __IndexService : I__IndexService
{
    ...
    /// </summary>
    public async ValueTask<__IndexNodeResult> GetNodeAsync(PageAddress indexNodeID)
    {
        using var _pc = PERF_COUNTER(5, nameof(GetNodeAsync), nameof(__IndexService));
    ...
    public async ValueTask<__IndexNodeResult> FindAsync(IndexDocument index, BsonValue key, bool sibling, int order)
    {
        ...
        return __IndexNodeResult.Empty;
    }
    ...
    /// </summary>
    public async ValueTask DeleteAllAsync(__IndexNodeResult nodeResult)
    {
    ...
    /// </summary>
    private async ValueTask DeleteSingleNodeAsync(__IndexNodeResult nodeResult)
    {
