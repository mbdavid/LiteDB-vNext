...
internal struct IndexNode
{
    ...
    {
        ENSURE(this, x => x.RowID.PageID == page.Header.PageID, $"should be same index page {page}");
    ...
    {
        ENSURE(this, indexNode => indexNode.RowID.PageID == page.Header.PageID, $"Should be same index page {page}");
