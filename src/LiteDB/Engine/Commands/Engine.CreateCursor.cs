...
{
    public Guid CreateCursor(Query query, BsonDocument? parameters)
        => this.CreateCursorInternal(query, parameters).CursorID;

    public Guid CreateCursor(Query query, BsonDocument? parameters, out string explanPlain)
    {
        var cursor = this.CreateCursorInternal(query, parameters);
    ...
    private Cursor CreateCursorInternal(Query query, BsonDocument? parameters = null)
    {
